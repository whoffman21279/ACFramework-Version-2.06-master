...
namespace ACFramework
{
    class BitmapRes
    {
        ...
        //added for Zombie Project
        public static readonly int Woods1 = 9;//new
        public static readonly int Sky2 = 10;
        public static readonly int Stones1 = 11;
        public static readonly int Wall1 = 12;
        public static readonly int Pebbles = 13;
        public static readonly int Sand = 14;
        public static readonly int Sky3 = 15;//new
        public static readonly int Sky4 = 16;//new
        public static readonly int WoodsFloor = 17;//new
    ...
    class ModelsMD2
    {
        ...
        public static readonly int Squirtle = 7;
        ...
        private static readonly ModelsMD2Info[] minfo = {
            ...
            new ModelsMD2Info( "Squirtle", "squirt.pcx", 0.2f, true)
        };            
